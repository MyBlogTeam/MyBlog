...
public String toString() {
	return "UserInfo [userId=" + userId + ", userName=" + userName
			...
			+ ", userEmail=" + userEmail + ", userPic=" + userPic
			+ ", userRank=" + userRank + ", userState=" + userState
			+ ", userIsDel=" + userIsDel + ", blogs=" + blogs + ", replys="
			+ replys + ", senders=" + senders + ", receivers=" + receivers
			+ ", files=" + files + ", clickLikes=" + clickLikes + ", collects="
			+ collects + ", discussInfos=" + discussInfos + ", userNotices="
			+ userNotices + ", albums=" + albums + ", labels=" + labels
			+ ", auths=" + auths + "]";
}
