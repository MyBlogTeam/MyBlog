...
public class ArticleInfo implements Serializable{
	...
	public ArticleInfo(int articleId, String articleTitle,
			Timestamp articleDate, String articleContent, int articlePeople,
			int articleState, String articlePic, boolean articleIsDel,
